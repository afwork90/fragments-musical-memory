...
const rawFragments: Omit<Fragment, "waveform" | "audio">[] = [
  { id:"f01", name:"Balcony guitar, 1:14am", source:"Balcony ideas — take 1.m4a", date:"2026-08-18", dateLabel:"Aug 18, 2026", duration:"0:18", key:"A minor", alternateKeys:["C major"], bpm:92, role:"Harmony", roles:["Harmony","Rhythm"], brightness:46, duplicateGroup:"balcony", objects:heroObjects("f01") },
  ...
  { id:"f07", name:"Balcony guitar — take 2", source:"Balcony ideas — take 2.m4a", date:"2026-08-18", dateLabel:"Aug 18, 2026", duration:"0:20", key:"A minor", alternateKeys:["C major"], bpm:91, role:"Harmony", roles:["Harmony"], brightness:44, duplicateGroup:"balcony" },
  { id:"f08", name:"Balcony guitar / phone pocket", source:"Balcony ideas — pocket.m4a", date:"2026-08-18", dateLabel:"Aug 18, 2026", duration:"0:17", key:"A minor", alternateKeys:[], bpm:93, role:"Harmony", roles:["Harmony","Texture"], brightness:32, duplicateGroup:"balcony" },
  ...
  { id:"f10", name:"Balcony guitar ending", source:"Balcony ideas — ending.m4a", date:"2026-08-18", dateLabel:"Aug 18, 2026", duration:"0:08", key:"A minor", alternateKeys:[], bpm:92, role:"Melody", roles:["Melody","Harmony"], brightness:49, duplicateGroup:"balcony" },
  ...
  { id:"f16", name:"Broken-string waltz", source:"Acoustic repairs.m4a", date:"2018-06-03", dateLabel:"Jun 03, 2018", duration:"0:21", key:"D major", alternateKeys:["B minor"], bpm:72, role:"Harmony", roles:["Harmony","Rhythm"], brightness:58 },
  ...
  { id:"f18", name:"Soft-synth bridge", source:"Juno fragments.wav", date:"2020-12-29", dateLabel:"Dec 29, 2020", duration:"0:18", key:"A minor", alternateKeys:["C major"], bpm:184, role:"Harmony", roles:["Harmony","Texture"], brightness:63 },
  ...
  { id:"f22", name:"Voice note — two notes", source:"Voice Memo 509.m4a", date:"2026-01-12", dateLabel:"Jan 12, 2026", duration:"0:06", key:"Could fit several keys", alternateKeys:["G major","E minor","C major"], bpm:78, role:"Melody", roles:["Melody","Voice"], brightness:62 },
  ...
  { id:"f25", name:"Open-tuning sketch", source:"Acoustic repairs.m4a", date:"2018-06-03", dateLabel:"Jun 03, 2018", duration:"0:25", key:"D major", alternateKeys:["G major"], bpm:86, role:"Harmony", roles:["Harmony","Melody"], brightness:66 },
  { id:"f26", name:"Neon arpeggio", source:"Juno fragments.wav", date:"2020-12-29", dateLabel:"Dec 29, 2020", duration:"0:12", key:"F♯ minor", alternateKeys:["A major"], bpm:116, role:"Melody", roles:["Melody","Harmony"], brightness:86 },
...
export const FRAGMENTS: Fragment[] = rawFragments.map((fragment, index) => ({ ...fragment, waveform: wave(index + 3), audio: `/audio/f${String(index + 1).padStart(2, "0")}.wav` }));
...
export const SOURCE_FILES: SourceFile[] = [
  { id:"s1", name:"Balcony ideas — take 1.m4a", date:"Aug 18, 2026", duration:146, format:"M4A · 11.4 MB", device:"iPhone microphone", fragmentIds:["f01","f10"], waveform:wave(41,72), sensitivity:46, start:22, end:40 },
  { id:"s2", name:"Voice Memo 184.m4a", date:"Jan 06, 2018", duration:93, format:"M4A · 6.8 MB", device:"iPhone microphone", fragmentIds:["f02","f22"], waveform:wave(17,72), sensitivity:58, start:18, end:31 },
  { id:"s3", name:"Practice room spill.wav", date:"Oct 23, 2021", duration:284, format:"WAV · 24.1 MB", device:"Room recorder", fragmentIds:["f03","f21","f24"], waveform:wave(28,72), sensitivity:67, start:64, end:73 },
  { id:"s4", name:"Tascam side B.aif", date:"May 17, 2017", duration:411, format:"AIFF · 38.7 MB", device:"Tascam DR-05", fragmentIds:["f06","f23"], waveform:wave(8,72), sensitivity:34, start:102, end:118 },
  { id:"s5", name:"Juno fragments.wav", date:"Dec 29, 2020", duration:196, format:"WAV · 18.2 MB", device:"Audio interface", fragmentIds:["f18","f26"], waveform:wave(53,72), sensitivity:52, start:48, end:66 },
  { id:"s6", name:"Acoustic repairs.m4a", date:"Jun 03, 2018", duration:328, format:"M4A · 21.3 MB", device:"Phone microphone", fragmentIds:["f16","f25"], waveform:wave(67,72), sensitivity:39, start:83, end:104 },
];
